...
function ProfilePageContainer(props) {
    ...
    return (
        <div className={styles.profilePageContainer}>
            ...
            <ProfilePage fname={props.data.firstName} mname={props.data.middleName} lname={props.data.lastName} email={props.data.email} number={props.data.phoneNum} role={convertedRole} />
        </div>
    );
}
